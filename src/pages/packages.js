...
const PackagesPage = ({data}) => (	
	<div className="packages">
	  <div 
	    ...
	    >
	    <Section sectionImage={data.hobsImage} title="What do I get for packages based od (hobs) flying time?" text="Flying time is measured by the Hobbs meter- an instrument on board of the helicopter. The Hobbs meter begins to count flying time when the pilot pulls up the collective. Raising the collective causes the helicopter to climb – at this point the Hobbs meter starts tracking your flying time. Hobbs meter does not record time while helicopter is being on the ground with collective down- at pick up or landing zone, while refuelling…  We strongly believe this is the most honest way for our clients when buying heliskiing packages.
...
" heli="1 helicopter –small group of 4 skiers 1 guide—3 groups max per 1 helicopter—4 (hobs) hours of flying time per 1 group of 4 skiers
" includes="The package includes 7 nights with full board accommodation, 4(hobs) hours (heliski),  6 days of skiing, IFMGA mountain guides" price="6350€ per person" />
      <Section sectionImage={data.privateImage} title="Private Heliski Albania" description="Having the whole operation and 1500 square km of mountains for yourself. We guarantee you will have the best possible experience. In this package you will have 8-12 (hobs) hours of fly time in a helicopter with up to max. 12 people in the group. Come with your buddies and have the entire Albanian Prokletije mountains for yourself. Program is based on fly time, so we can choose to ski the best terrain  that suits you group and find the best snow available at the time of you stay.
" heli="1 helicopter only for your group— entire operation only for your group--up to 12 people in a group- up to 12(hobs) hours of flying time
