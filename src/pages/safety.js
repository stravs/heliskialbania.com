...
const SafetyPage = ({data}) => (	
	<div className="expiriance">
	  <div 
	    ...
	    >
	    <Section altText="Pieps Micro in action" sectionImage={data.safetyImage} title="Our guides" text="All our guides are fully qualified IFMGA guides with special training for heliskiing.
